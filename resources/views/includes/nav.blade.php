                ...
                <div class="group relative ">
                    ...
                    <ul class="hidden absolute group-hover:block w-32">
                        <li><a href="#"
                                ...
                                1</a></li>
                        <li><a href="#"
                                class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap">Option
                                2</a></li>
                        <li><a href="#"
                ...
                <div class="group relative">
                    ...
                    <ul class="hidden absolute group-hover:block">
                        <li><a href="#"
                                ...
                                1</a></li>
                        <li><a href="#"
                                class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap">Option 2</a>
                        </li>
                        <li><a href="#"
                                class="rounded-b bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap">Option
                                3</a></li>
